...
public class IngestionWorkflowImpl implements IngestionWorkflow {
        ...
        private IngestionActivities activityStub = Workflow.newActivityStub(IngestionActivities.class);
     ...
     public void ingest(String customerId, String accountId) {
            ...
            continueWork = false;
            logger.info("started workflow for account {}", accountId);
            List<Data> dataList = new ArrayList<>();
            dataList = activityStub.fetchDataActivity(customerId, accountId);
